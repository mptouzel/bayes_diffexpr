...
% \begin{align}
% \mathcal{L}(\alpha,\bar{s})=\frac{1}{N_{clones}}\sum_{(n_1,n_2)_{data}}\log P_{\mathrm{\textrm{diff}}}(n_1,n_2)
% \end{align}
% where
% \begin{align}
% P_{\mathrm{\textrm{diff}}}(n_1,n_2)=\int_{s_{min}}^{s_{max}}P(n_1,n_2|s)\rho(s)\mathrm{d}s\;.
% \end{align}
